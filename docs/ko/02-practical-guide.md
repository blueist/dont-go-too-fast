...
- "인식"이 불가능
- DGTF 적용 불가
- → 먼저 Wow가 일어날 조건을 만들어야 함

**Wow가 있으면:**
- 문이 잠깐 열림
- 하지만 뭘 해야 할지 모르면 문이 닫힘
- System 1이 "괜찮아, 가자"라고 하고 넘어감
- → DGTF가 그 순간을 활용하는 방법을 제공
...
DGTF 없이 Wow는 놓친 기회일 뿐이다.
Wow 없이 DGTF는 시작조차 못한다.
```
...
"이번엔 진짜 급해, DGTF 할 시간 없어!"
→ 이건 정확히 System 1이 하는 말이다.
→ 그리고 정확히 DGTF가 가장 필요한 순간이다.
...
애자일은 어려운 프로젝트에서 더 효과적이다.
쉬운 프로젝트는 어떤 방법론이든 살아남는다.
...
DGTF는 여유로운 시간을 위한 사치가 아니다.
DGTF는 어려운 시간을 위한 필수다.
...
범위를 명확히 해야 거짓 약속과 실망을 방지할 수 있다.
...
환경이 DGTF를 허용하지 않으면:
선택 1: 그 환경을 떠나라.
선택 2: 내가 통제할 수 있는 작은 범위 안에서 DGTF를 적용하라.
```
...
DGTF는 조직에 선언하는 게 아니다.
DGTF는 조용히 자기 자신을 통제하는 것이다.
...
**2.1 변경사항:**
- DGTF에 "전제조건: Wow 순간" 섹션 추가
- "LA 비유" 섹션 추가
- "DGTF가 해결하지 않는 것" 섹션 추가
- "DGTF ≠ 느림"에 의지력 설명 추가
- "본질" 섹션에 훈련 vs 학습 구분 강화
